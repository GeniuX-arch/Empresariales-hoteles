    ...
    <nav className="bg-gray-800 shadow-lg text-gray-100">
      <div className="container mx-auto flex justify-between items-center p-4">
        ...
        <ul className="flex space-x-6">
          <li>
            <Link className="text-gray-100 hover:text-blue-600 font-semibold" to="/">
              Home
            </Link>
          </li>
          <li>
            <Link className="text-gray-100 hover:text-blue-600 font-semibold" to="/hoteles">
              Hoteles
            </Link>
          </li>
          <li>
            <Link className="text-gray-100 hover:text-blue-600 font-semibold" to="/contacto">
              Contacto
            </Link>
          </li>
